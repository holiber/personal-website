...
description: |
  ...
  One of the most exciting projects I worked on was Streamlabs Desktop (formerly Streamlabs OBS).
  Our small team built it from the ground up, and I was deeply involved in shaping it from day one.
  It’s an open-source app that helps streamers go live on popular platforms, interact with their audience, design their stream layout, and grow their channels.

  The app is built with Electron, React, and Ant Design.

image: "./image.png"
media: "/img/project-streamlabs-desktop/sl-desktop.webm"
